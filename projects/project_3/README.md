...
**Wednesday, November 27**: Project presentation day! We will be meeting at our regular 9:00 AM class time. Please note: there will be a lengthy install (Ruby, Rails, Postgres) after presentations
...
[Here](./../working_in_groups.md) are some helpful tips/advice to working in groups as a developer
...
Before you begin coding, make new GitHub repos for your project. _Take the following steps to ensure you have the right set up in order to deploy your site to Heroku. If you need a reminder on deploying a server to Heroku, look back at the [deployment notes](/unit_2/w07d02/instructor_notes/heroku.md)_ 
...
[Here](https://git.generalassemb.ly/sei-stamford/sei-triforce/blob/master/unit_3/w09d04/instructor_notes/Create%20React%20App%20%26%20Surge.md) is a link to client side setup for deployment of your React app
...
**Thursday morning, November 21 - Mandatory**<br>
...
Your project is due on Wednesday, November 27 at 9:30 am ET. Your group will present your project and show your code to classmates and instructors.

:heavy_check_mark: Add your group project to [this google sheet](https://docs.google.com/spreadsheets/d/1SzG_8F0E71RjesTFy9E2Dwf06J3DFfEizZDP_XznJsc/edit?usp=sharing).  Note that this is the order you will be presenting.
