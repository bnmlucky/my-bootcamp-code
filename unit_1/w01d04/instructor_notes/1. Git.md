...
- When you use `https` to connect to github, it will likely ask for your password .
...
<hr> -->
<!--
Making a local folder, turning it into a git repo, pushing it up to Github -->
...
1. Grab the first line and paste it in terminal it will be something like: `git remote add origin https://github.com/username/new_repo`
